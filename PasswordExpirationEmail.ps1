...
$FromEmail = "rfaadmin@sunlightfinancial.com"
...
If (!($CredObjCheck))
{
	...
	$Credential = Get-Credential -Message "Please enter your credential that you will use to send e-mail from $FromEmail. If you are not using the account $FromEmail make sure this account has 'Send As' rights on $FromEmail."
	#Export cred obj
...
Please note If you do not update your password in $DaysToExpire days, you will not be able to log in.

Tips:  You should use a series of words and substitute letters with special characters and/or numbers to make your password/passphrase even stronger.

If you need help resetting your password please contact the RFA Help Desk 24/7 at help@rfa.com or (212)867-4600 option 2.

Sincerely, 
Sunlight IT Department."
